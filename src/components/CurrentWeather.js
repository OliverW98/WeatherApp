    ...
    <div className="box">
      <div className="media">
        ...
        <div className="media-content">
          ...
          <p className="subtitle is-4">{props.data.weather[0].description}</p>
        </div>
        <div className="media-content-right">
          ...
          <p className="is-size-3 has-text-right">
            {props.data.temp.toFixed(1)} {props.isUsingMetric ? "°C" : "°F"}
          </p>
          <p className="is-size-3 has-text-right">
            <i className="fas fa-location-arrow rotate mr-3" style={style}></i>
      ...
      <div className="columns">
        <div className="column">
          ...
          {props.data.rain != null ? <p>Rain : {props.data.rain} mm</p> : null}
        </div>
        <div className="column">
